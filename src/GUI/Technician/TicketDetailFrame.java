...
public class TicketDetailFrame extends JFrame {
    ...
    public TicketDetailFrame(String ticketId) {
        ...
        p.add(Box.createVerticalStrut(5));
        JTextArea desc = new JTextArea("The computers in room 5 cannot connect to the internet since this morning.", 3,
                0);
        ...
        reason.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(200, 200, 200)),
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new TicketDetailFrame("test-ticket-id").setVisible(true));
    }
}
